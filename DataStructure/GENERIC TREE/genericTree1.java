...
// public static boolean findingNode (Node node , int x)
// {
...
// for(Node child : node.children)
// {
//   boolean fic = findingNode(child , x);
...
//  }
 ...
 public static void linearization(Node node)
{
...
// ------------------------------------------------------------------------------------------------------
  ...
  public static void main(String[] args) throws Exception {
    ...
    // mirror(root);
    // removalOfLeaf(root);
    // System.out.println(findingNode(root, x));
    linearization(root);
